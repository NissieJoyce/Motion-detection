...
video=cv2.VideoCapture(0) #0=>webcam  ,cv2.CAP_DSHOW
video.read()
time.sleep(2)
status = 0
...
while True:
    ...
    if first_frame is None:
        first_frame=gray
        continue    #goto beginning of while loop without executing the remaining lines
    ...
    if status_list[-1] == 1 and status_list[-2] == 0:       #comparing the last 2 items in the list
